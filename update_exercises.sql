USE codeup_test_db;
    ...
    SELECT name As 'All the Albums by Michael Jackson', artist As 'Artist' FROM albums WHERE artist = 'Michael Jackson';

    UPDATE name SET artist = 'Peter Jackson' WHERE artist = 'Michael Jackson';
